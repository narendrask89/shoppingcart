...
import static com.nandulabs.shoppingcart.admin.web.utils.MessageCodes.*;
 ...
 */
@Controller
public class UserAuthController extends ShoppingCartAdminBaseController {
	...
	public String handleForgotPwd(HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		try {
			...
			String resetPwdURL = WebUtils.getURLWithContextPath(request) + "/resetPwd?email=" + email + "&token="
					+ token;
